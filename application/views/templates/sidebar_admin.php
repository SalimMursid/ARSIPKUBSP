        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url('admin/lap_harian'); ?>"><i class="fa fa-circle-o"></i> Laporan Keuangan</a></li>
                    <li><a href="<?php echo base_url('admin/lap_bulanan'); ?>"><i class="fa fa-circle-o"></i> Laporan Karantina & Imigrasi</a></li>
                    <li><a href="<?php echo base_url('admin/lap_tahunan'); ?>"><i class="fa fa-circle-o"></i> Laporan Kepelabuhan & Bea Cukai</a></li>
                    <li><a href="<?php echo base_url('admin/lap_lain'); ?>"><i class="fa fa-circle-o"></i> Laporan Administrasi Umum</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
