...
class User extends CI_Controller
{
    ...
    public function lap_bulanan()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Laporan Karantina & Imigrasi';
            $data['user'] = $this->db->get_where('mst_user', ['username' => $this->session->userdata('username')])->row_array();
    ...
    public function edit_lap_bulanan($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['title'] = 'Edit Laporan Karantina & Imigrasi';
            $data['user'] = $this->db->get_where('mst_user', ['username' => $this->session->userdata('username')])->row_array();
    ...
    public function lap_tahunan()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['title'] = 'Laporan Kepelabuhan & Bea Cukai';
            $data['user'] = $this->db->get_where('mst_user', ['username' => $this->session->userdata('username')])->row_array();
    ...
    public function edit_lap_tahunan($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['title'] = 'Edit Laporan Kepelabuhan & Bea Cukai';
            $data['user'] = $this->db->get_where('mst_user', ['username' => $this->session->userdata('username')])->row_array();
