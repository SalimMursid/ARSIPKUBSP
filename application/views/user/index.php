  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="info-box bg-red">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Laporan Karantina & Imigrasi</span>
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="info-box bg-lime">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Laporan Kepelabuhanan & Bea Cukai</span>
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        <li class="active"><a href="#activity" data-toggle="tab" style="font-weight:800;">Laporan Keuangan</a></li>
        <li><a href="#settings" data-toggle="tab" style="font-weight:800;">Laporan Karantina & Imigrasi</a></li>
        <li><a href="#laptahunan" data-toggle="tab" style="font-weight:800;">Laporan Kepelabuhan & Bea Cukai</a></li>
        <li><a href="#laplain" data-toggle="tab" style="font-weight:800;">Laporan Administrasi Umum</a></li>
